...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className='container-fluid p-lg-4 p-0' >
            <div className='homepage-first-section' style={{borderRadius:"16px",position:"relative",height:"800px"}}>
  ...
  <div className="container-fluid mt-3">
    ...
    <div className="collapse navbar-collapse d-flex justify-content-between px-5" id="navbarSupportedContent">
    ...
    <a onClick={(e) => e.preventDefault()}>
      ...
      <GrFormSearch size={30} />
       ...
       style={{height:"800px",position:'absolute',top:"0",left:"0",right:"0"}}
      >
         <SwiperSlide>
          
          <div className="slide-content" style={{position:"relative",backgroundColor:"black",borderRadius:"24px"}}>
            <img src={bannerone} alt='img' style={{height:"800px",width:"100%",objectFit:"cover",objectPosition:"top",borderRadius:"24px",opacity:".5"}}/>
          </div>
          ...
          <div className='slide-content-box'>
            <div className='p-3'>
              <Fade direction='in' duration={2000}>
                ...
                <Zoom direction='out'>
                <p style={{ width : "500px", whitespace : "normal", wordWrap : "break-word", overflow : "hidden"}}>Looking for the best Naturopathy and Health services in town? Our team of experienced Naturopathist offers all the Health services  with holistic approch you’ve been waiting for. </p>
                </Zoom>
                <Fade direction='in'>
        ...
        <SwiperSlide>
        <div className="slide-content" style={{position:"relative",backgroundColor:"black",borderRadius:"24px"}}>
            <img src={bannertwo} alt='img' style={{height:"800px",width:"100%",objectFit:"cover",objectPosition:"top",borderRadius:"24px",opacity:".5"}}/>
          </div>
          <div className='slide-content-box'>
            <div className='p-3'>
              <Fade direction='in' duration={2000}>
                ...
                <hr style={{borderTop:"1px solid white",opacity:"1"}}/>
                <Zoom direction='out'>
                <p style={{ width : "500px", wordWrap : "break-word", overflow : "hidden"}}>Looking for the best Naturopathy and Health services in town? Our team of experienced Naturopathist offers all the Health services  with holistic approch you’ve been waiting for. </p>
                </Zoom>
                <Fade direction='in'>
                <button href="#" className="button" style={{ '--clr': 'white' }}>
                CONTACT US
        ...
        <SwiperSlide>
        <div className="slide-content" style={{position:"relative",backgroundColor:"black",borderRadius:"24px"}}>
            <img src={bannerthree} alt='img' style={{height:"800px",width:"100%",objectFit:"cover",objectPosition:"top",borderRadius:"24px",opacity:".5"}}/>
          </div>
          <div className='slide-content-box'>
            <div className='p-3'>
              <Fade direction='in' duration={2000}>
            ...
            <div className='row mx-0 pt-5' style={{marginTop:"-25px",zIndex:"-2",position:"relative",borderEndEndRadius:"24px",borderEndStartRadius:"24px",backgroundColor:"var(--secondary-color)",backgroundImage:`url(${pattern})`}}>
          ...
          <div className="pbmit-ihbox-style-1 h-100">
            <div className="pbmit-ihbox-headingicon h-100 d-flex align-items-center">
              ...
              <p style={{fontFamily:"var(--para-font)",fontSize:"20px",textAlign:"start",paddingLeft:"20px"}} className="pbmit-element-title">
        ...
        <div className="col-12 col-lg-4 p-3 pb-5">
          <div className="spinner_box">
            <div className="pbmit-spinner-box-style-1" style={{position:"relative"}}>
            <FaArrowDown size={40} color='black' style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)"}}/>
        ...
        <div className="col-12 col-lg-4 p-3 pb-5">
          <div className="pbmit-ihbox-style-3 h-100">
            <div className="pbmit-ihbox-headingicon d-flex align-items-center h-100">
              <div className="pbmit-ihbox-contents">
                <p style={{fontFamily:"var(--para-font)",fontSize:"20px",textAlign:"end",paddingRight:"20px"}} className="pbmit-element-title">
